...
public class SimpleCourse {
    ...
    // Se ho solo il token
    public SimpleCourse(Integer id, String token, String name, int year, String subject, int maxSubscribed, Integer classroom, LocalDate startDate, LocalDate finishDate, String type, String description) {
        this.id = id;
        this.token = token;
        this.name = name;
        this.year = year;
